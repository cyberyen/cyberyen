...
bech32_templates = [
  ...
  ('cy',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('cy',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('cy',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('cy',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tcy',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tcy',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tcy',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tcy',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tcy',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tcy',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tcy',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tcy',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rcy',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rcy',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rcy',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rcy', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tcy',   17, 32, Encoding.BECH32M, False, False, False),
  ('rcy',  3,  1, Encoding.BECH32M, False, False, False),
  ('lcy',   15, 41, Encoding.BECH32M, False, False, False),
  ('tcy',    0, 16, Encoding.BECH32,  False, False, False),
  ('rcy',  0, 32, Encoding.BECH32,  True,  False, False),
  ('cy',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tcy',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rcy',  0, 20, Encoding.BECH32,  False, False, True),
  ('cy',    0, 20, Encoding.BECH32M, False, False, False),
  ('tcy',    0, 32, Encoding.BECH32M, False, False, False),
  ('rcy',  0, 20, Encoding.BECH32M, False, False, False),
  ('cy',    1, 32, Encoding.BECH32,  False, False, False),
  ('tcy',    2, 16, Encoding.BECH32,  False, False, False),
  ('rcy', 16, 20, Encoding.BECH32,  False, False, False),
]
