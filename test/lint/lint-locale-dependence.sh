...
KNOWN_VIOLATIONS=(
    ...
    "src/wallet/txrecord.cpp:.*to_string"
)

REGEXP_IGNORE_EXTERNAL_DEPENDENCIES="^src/(crypto/blake3/|crypto/ctaes/|leveldb/|libmw/|secp256k1/|secp256k1-zkp/|tinyformat.h|univalue/)"
