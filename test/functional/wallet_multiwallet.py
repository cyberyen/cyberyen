...
class MultiWalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(w5_info['immature_balance'], subsidy_cy())
        ...
        for wallet_name, wallet in zip(wallet_names, wallets):
            ...
            assert_equal(info['immature_balance'], subsidy_cy() if wallet is wallets[0] else 0)
        ...
        assert_equal(w1.getbalance(), 2 * subsidy_cy())
