...
class WalletLabelsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        BECH32_VALID = {
            '✔️_VER15_PROG40': 'rcy10qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqevpw9x',
            '✔️_VER16_PROG03': 'rcy1sqqqqqap5g4h',
            '✔️_VER16_PROB02': 'rcy1sqqqqfsjxnh',
        }
        BECH32_INVALID = {
