...
# The block reward of coinbaseoutput.nValue (subsidy_cy()) CY/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * subsidy_cy() /block.
BLOCKS = 101
BALANCE = (BLOCKS - 100) * subsidy_cy()
...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `cyberyen-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            ...
            amounts = [BALANCE + subsidy_cy() - Decimal('40.000072'), Decimal(9), Decimal(31)]
            ...
            # Mine a block to confirm; adds a block reward (subsidy_cy()) to the default wallet.
