...
"""Verify that starting cyberyen with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start cyberyen with -h for help text")
        ...
        self.log.info("Start cyberyen with -version for version information")
        ...
        self.log.info("Start cyberyend with -fakearg to make sure it does not start")
