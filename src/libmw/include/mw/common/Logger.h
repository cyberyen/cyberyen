...
#define LOG_DEBUG(message) LoggerAPI::Log(LoggerAPI::LogLevel::LOG_DEBUG, __FUNCTION__, __LINE__, message)
...
#define LOG_DEBUG_F(message, ...) LOG_F(LoggerAPI::LogLevel::LOG_DEBUG, __FUNCTION__, __LINE__, message, __VA_ARGS__)
...
#define WALLET_DEBUG(message) LoggerAPI::Log(LoggerAPI::LogLevel::LOG_DEBUG, __FUNCTION__, __LINE__, message)
...
#define WALLET_DEBUG_F(message, ...) LOG_F(LoggerAPI::LogLevel::LOG_DEBUG, __FUNCTION__, __LINE__, message, __VA_ARGS__)
