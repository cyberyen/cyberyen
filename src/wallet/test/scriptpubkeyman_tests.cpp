...
BOOST_AUTO_TEST_CASE(StealthAddresses)
{
    ...
    // Set HD seed
    CKey key = DecodeSecret("6EznnAHgUzUW1hooqNiZvn6DY938GaVFyMxKGuTURFFmLmeaFrh");
    ...
    BOOST_CHECK(EncodeDestination(change_address) == "cymweb1qq20e2arnhvxw97katjkmsd35agw3capxjkrkh7dk8d30rczm8ypxuq329nwh2twmchhqn3jqh7ua4ps539f6aazh79jy76urqht4qa59tsyjmhzv");
    ...
    BOOST_CHECK(EncodeDestination(pegin_address) == "cymweb1qqg5hddkl4uhspjwg9tkmatxa4s6gswdaq9swl8vsg5xxznmye7phcqatzc62mzkg788tsrfcuegxe9q3agf5cplw7ztqdusqf7x3n2tl55n6cpww");
    ...
    BOOST_CHECK(EncodeDestination(receive_address) == "cymweb1qq0yq03ewm830ugmkkvrvjmyyeslcpwk8ayd7k27qx63sryy6kx3ksqm3k6jd24ld3r5dp5lzx7rm7uyxfujf8sn7v4nlxeqwrcq6k6xxwqch2x45");
