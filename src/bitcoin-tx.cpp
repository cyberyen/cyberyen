...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " cyberyen-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  cyberyen-tx [options] <hex-tx> [commands]  Update hex-encoded cyberyen transaction\n" +
            "or:     cyberyen-tx [options] -create [commands]   Create hex-encoded cyberyen transaction\n" +
            "\n";
