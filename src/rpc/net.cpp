...
static RPCHelpMan addconnection()
{
	...
	RPCExamples{
	    HelpExampleCli("addconnection", "\"192.168.0.6:58383\" \"outbound-full-relay\"")
	    + HelpExampleRpc("addconnection", "\"192.168.0.6:58383\" \"outbound-full-relay\"")
	},
	[&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
...
static RPCHelpMan disconnectnode()
{
    return RPCHelpMan{"disconnectnode",
		...
		RPCResult{RPCResult::Type::NONE, "", ""},
		RPCExamples{
		    HelpExampleCli("disconnectnode", "\"192.168.0.6:58383\"")
	    + HelpExampleCli("disconnectnode", "\"\" 1")
	    + HelpExampleRpc("disconnectnode", "\"192.168.0.6:58383\"")
    ...
    return RPCHelpMan{"getaddednodeinfo",
		...
		RPCResult{
			...
			{RPCResult::Type::OBJ, "", "",
			{
				...
				{RPCResult::Type::OBJ, "", "",
				{
				    {RPCResult::Type::STR, "address", "The cyberyen server IP and port we're connected to"},
...
static RPCHelpMan addpeeraddress()
{
	...
	RPCExamples{
	    HelpExampleCli("addpeeraddress", "\"1.2.3.4\" 58383")
    + HelpExampleRpc("addpeeraddress", "\"1.2.3.4\", 58383")
	},
	[&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    NodeContext& node = EnsureNodeContext(request.context);
