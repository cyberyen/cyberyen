# Support for Output Descriptors in Cyberyen Core

Since Cyberyen Core v0.17, there is support for Output Descriptors. This is a
...
existing Cyberyen Core wallets, a convenience function `combo` is
