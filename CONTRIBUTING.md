Contributing to Cyberyen Core
============================

The Cyberyen Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Cyberyen Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/cyberyen-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to cyberyen-qt
...
The following applies to code changes to the Cyberyen Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Cyberyen
Network Protocol consensus changes.

Whether a pull request is merged into Cyberyen Core rests with the project merge
...
Patches that change Cyberyen consensus rules are considerably more involved than
...
Where a patch set proposes to change the Cyberyen consensus, it must have been
...
The project leader is the release manager for each Cyberyen Core release.
